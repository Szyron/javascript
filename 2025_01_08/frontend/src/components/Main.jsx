    ...
    <div className="container mx-auto flex md:px-24 md:py-10 md:flex-row flex-col items-center">
        <div
            ...
            <p className="mb-8 md:pl-0  pl-2 pr-2 leading-relaxed dark:text-gray-300">
                Udvozoljuk az orvosi rendelo hivatalos oldalan!
            </p>
        </div>
        <div className="lg:max-w-lg lg:w-full mb-5 md:mb-0 md:w-1/2 w-3/6">
            <img className="object-cover object-center rounded" alt="hero" src="https://www.svgrepo.com/show/63470/pet-hotel-building-with-verification-sign.svg"/>
        </div>
    </div>
</section>
  )
